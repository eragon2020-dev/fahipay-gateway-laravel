...
<head>
    ...
    <style>
        ...
        .cancel-card { max-width: 500px; margin: 50px auto; }
        .cancel-icon { font-size: 4rem; color: #ffc107; }
    </style>
</head>
<body>
    <div class="container">
        <div class="card cancel-card shadow">
            <div class="card-body text-center py-5">
                <div class="cancel-icon mb-3">!</div>
                <h2 class="text-warning">Payment Cancelled</h2>
                <p class="text-muted">You have cancelled the payment process.</p>
